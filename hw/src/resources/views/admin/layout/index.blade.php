...
<head>
    ...
    <title>@yield('title') - 管理后台 - {{ config('sys.web.title') }}</title>
...
<header class="navbar navbar-expand flex-md-row bd-navbar">
    <div class="navbar-nav-scroll">
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link nav-logo-name d-none d-sm-block" href="/"><i class="fa fa-cloud"></i> 征途后台管理</a>
                <a class="nav-link nav-logo-name d-sm-none" href="/"><i class="fa fa-cloud"></i> 管理系统</a>
            </li>
        </ul>
    </div>
...
<div class="container-fluid">
    <div class="row flex-xl-nowrap">
        <div class="col-12 col-md-3 col-xl-2 bd-sidebar">
            ...
            <div class="menu-item">
                <a class="menu-link" data-toggle="collapse" href="#menu-jf">
                    <i class="bi bi-coin"></i> 积分管理
                    <i class="bi bi-coin float-right"></i>
                </a>

                <ul class="collapse" id="menu-jf">
                    <li>
                        <a href="/admin/jf/zj">
                            <i class="fa fa-caret-right"></i> 积分操作
                        </a>
                    </li>
                </ul>
            </div>
