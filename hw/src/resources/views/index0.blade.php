...
<head>
    ...
    <?php //<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3747818936581803"?>
     <?php //crossorigin="anonymous"></script>?>
    <script type="text/javascript">
	    function change(){
	    	var bodyBgs = [];
	    	bodyBgs[0] = "https://api.wdvipa.com/sj";
	    	bodyBgs[1] = "https://api.wdvipa.com/sj";
	    	bodyBgs[2] = "https://api.wdvipa.com/sj";
	    	bodyBgs[3] = "https://api.wdvipa.com/sj";
	    	bodyBgs[4] = "https://api.wdvipa.com/sj";
	    	bodyBgs[5] = "https://api.wdvipa.com/sj";
	    	bodyBgs[6] = "https://api.wdvipa.com/sj";
	    	bodyBgs[7] = "https://api.wdvipa.com/sj";
	    	bodyBgs[8] = "https://api.wdvipa.com/sj";
	    	bodyBgs[9] = "https://api.wdvipa.com/sj";
	    	bodyBgs[10] = "https://api.wdvipa.com/sj";
...
<body>
<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar bd-navbar-index" style="background: {{config('sys.theme.colour','#563d7c')}};">
    ...
    <div class="navbar-nav-scroll">
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            @endforeach
            <li class="nav-item">
                <a class="nav-link" href="/SRV">SRV生成器</a>
            </li>
        </ul>
    </div>
    ...
    @else
        <ul class="navbar-nav flex-row ml-md-auto d-md-flex">
            ...
            <li class="nav-item">
                <a class="nav-link p-2" href="/login2?act=reg">注册</a>
            </li>
        </ul>
    @endif
</header>
