        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-inline">
                    ...
                    <div class="form-group ml-1">
                        <input type="text" placeholder="主机记录" class="form-control">
                    </div>
                    <div class="form-group ml-1">
                        <input type="text" placeholder="记录值" class="form-control">
                    </div>
                    <a class="btn btn-info ml-1" @click="getList(1)">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="type" v-model="storeInfo.type">
                                        <option value="A">A记录(IP)</option>
                                        <option value="CNAME">CNAME</option>
                                        <option value="AAAA">AAAA(ipv6)</option>
                                        <option value="TXT">TXT</option>
                                        <option value="SRV">SRV</option>
                                    </select>
                                    <div style="border: 1px solid #ced4da;border-radius: .25rem;padding: .375rem .75rem;margin-top: .25rem;font-size: 14px;color: grey;">如需解析SRV却不清楚如何填写,请使用 <a href="/SRV">SRV记录生成器</a></div>
                                </div>
                            </div>
                            <div class="form-group row">
