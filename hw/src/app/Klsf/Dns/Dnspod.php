...
class Dnspod implements DnsInterface
{
    ...
    public function deleteDomainshare($Email, $DomainId = null, $Domain = null)
    {
        $params = [];
        $DomainId && $params['domain_id'] = $DomainId;
        $Domain && $params['domain'] = $Domain;
        $params['email'] = $Email;
        list($ret, $error) = $this->getResult("Domainshare.Remove", $params);
        return $ret ? [true, null] : [false, $error];
    }

    public function addDomainshare($Name, $Email, $Mode, $DomainId = null, $Domain = null)
    {
        $params = [];
        $DomainId && $params['domain_id'] = $DomainId;
        $Domain && $params['domain'] = $Domain;
        ...
        $params['email'] = $Email;
        $params['mode'] = $Mode;
        list($ret, $error) = $this->getResult("Domainshare.Create", $params);
        return $ret ? [[
            'Email' => $Email,
            'Name' => $Name,
            'Domain' => $Domain
