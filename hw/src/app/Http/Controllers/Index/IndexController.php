...
", $keywords);
            ...
            //$codewords = config('sys.codewords');
            //$codewords = explode("", $codewords);
            //$_codewords = [];
    ...
    public function reg(Request $request)
    {
        ...
        } elseif (!preg_match('/[1-9a-zA-z]{3,10}@qq.com/', $data['email'])) { ///[1-9a-zA-z]{3,10}@(gmail|qq).com/
            $result['message'] = '目前仅支持qq邮箱和gmail注册';
