...
use App\Helper;
use App\Http\Controllers\Home\ClassControllers;
...
class ConfigController extends Controller
{
    public function post(Request $request)
    {
        ...
        switch ($action) {
            ...
            case 'qk_activity':
                return $this->qk_activity($request);
            case 'config':
    ...
    private function qk_activity(Request $request)
    {
        $class = new ClassControllers();
        return $class->qk_activity($request);
    }
